...
func (r *RunnerEnv) AllocateTickets(
	...
	require.NoError(t, r.BridgeClient.RecoverMaxTickets(ctx, r.ContractOwner, numberOfTicketsToAllocate))
...
// RegisterCoreumOriginatedToken registers Coreum token and reruns stored token with all generated by contract
//
//	attributes.
