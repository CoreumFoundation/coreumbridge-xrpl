...
func init() {
	...
	flag.StringVar(&coreumCfg.PreviousContractPath, "coreum-previous-contract-path", "../../build/coreumbridge_xrpl_v1.1.0.wasm", "Path to previous smart contract bytecode")
