...
// SendXRPL mocks base method.
func (m *MockBridgeClient) SendXRPL(arg0 context.Context, arg1 string, arg2 data.Account, arg3 data.Amount) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendXRPL", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendXRPL indicates an expected call of SendXRPL.
func (mr *MockBridgeClientMockRecorder) SendXRPL(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendXRPL", reflect.TypeOf((*MockBridgeClient)(nil).SendXRPL), arg0, arg1, arg2, arg3)
}
